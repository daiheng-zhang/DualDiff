...
save_dir = f"outputs/composition_score/{idx1}/{idx2}"
os.makedirs(save_dir, exist_ok=True)


res_list_1 = load_pickle(f'outputs_eval/baseline_targetdiff/{idx1}/{idx1}/eval_all.pkl')
res_list_2 = load_pickle(f'outputs_eval/baseline_targetdiff/{idx1}/{idx2}/eval_all.pkl')
...
protein_path_1 = glob(f"data/processed/dock/ligand_protein_dataset_v2/{smiles1}/*/protein_clean.pdb")[0]
protein_path_2 = glob(f"data/processed/dock/ligand_protein_dataset_v2/{smiles2}/*/protein_clean.pdb")[0]
pocket_path_1 = glob(f"data/processed/dock/ligand_protein_dataset_v2/{smiles1}/*/pocket_10A.pdb")[0]
pocket_path_2 = glob(f"data/processed/dock/ligand_protein_dataset_v2/{smiles2}/*/pocket_10A.pdb")[0]
ligand_path_1 = glob(f"data/processed/dock/ligand_protein_dataset_v2/{smiles1}/*/ligand.sdf")[0]
ligand_path_2 = glob(f"data/processed/dock/ligand_protein_dataset_v2/{smiles2}/*/ligand.sdf")[0]
