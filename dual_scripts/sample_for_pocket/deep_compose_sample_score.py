...
from scripts.sample_diffusion import deep_compose_sample_diffusion_ligand
...
if __name__ == '__main__':
    ...
    if os.path.exists(os.path.join(result_path, f'sample.pt')):
        print(f"We found {os.path.join(result_path, f'sample.pt')}. Exit.")
        exit()
    ...
    all_pred_pos, all_pred_v, pred_pos_traj, pred_v_traj, pred_v0_traj, pred_vt_traj, time_list = deep_compose_sample_diffusion_ligand(
