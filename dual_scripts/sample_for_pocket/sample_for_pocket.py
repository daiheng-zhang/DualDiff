...
if __name__ == '__main__':
    ...
    with open('data/processed/dock/index_dict.pkl', 'rb') as f:
        index = pickle.load(f)
    real_ligand_smiles = index['idx_to_smiles'][args.data_id]
    data_dir = f"data/processed/dock/ligand_protein_dataset_v2/{real_ligand_smiles}"
    data_dir = glob.glob(f"{data_dir}/*")[0]
    pdb_path = f"{data_dir}/pocket_10A.pdb"
    logger.info(f"pdb_path: {pdb_path}")
